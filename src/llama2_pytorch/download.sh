...
read -r -p "Enter the URL from email: " PRESIGNED_URL
echo ""
read -r -p "Enter the list of models to download without spaces (7B,13B,70B,7B-chat,13B-chat,70B-chat), or press Enter for all: " MODEL_SIZE
